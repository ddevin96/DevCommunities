...
"""
function myfindcommunities(h::Hypergraph, method::CFLabelPropagationFinder)
    ...
    while !stop && iter < method.max_iter
        ...
        for e in edges
            ...
            l = my_compute_edge_label(h, e, vlabels, helabels, rng)
            push!(helabels, e => l)
        end
        ...
        for v in vertices
            ...
            l = my_compute_vertex_label(h, v, vlabels, helabels, rng)
            if l != vlabels[v]
                stop = false
                push!(vlabels, v => l)
            end
...
"""
function my_compute_vertex_label(h::Hypergraph, v::Int, vlabels::Dict{Int,Int}, helabels::Dict{Int,Int}, rng::MersenneTwister)
...
"""
function my_compute_edge_label(h::Hypergraph, e::Int, vlabels::Dict{Int,Int}, helabels::Dict{Int,Int}, rng::MersenneTwister)
    vₑ = getvertices(h,e)
    eL = Dict{Int,Int}()
